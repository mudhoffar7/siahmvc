...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    {{ stylesheet_link('template/bootstrap/dist/css/bootstrap.min.css',true)}}
    <!-- Menu CSS -->
    {{ stylesheet_link('template/plugins/bower_components/sidebar-nav/dist/sidebar-nav.css')}}
    <!-- animation CSS -->
    {{ stylesheet_link('template/css/animate.css')}}
    <!-- Custom CSS -->
    {{ stylesheet_link('template/css/style.css')}}
    <!-- color CSS -->
    {{ stylesheet_link('template/css/colors/default.css')}}
...
<body class="fix-header">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li class="user-pro">
                        <a href="#" class="waves-effect" style="display: inline-block;"><img src="{{url("template/plugins/images/users/varun.jpg")}}" alt="user-img" class="img-circle"> <span class="hide-menu">Nama Mahasiswa</span><span class="hide-menu" style="display: inline-block;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NRP Mahasiswa</span>
                        </a>
    ...
    {{javascript_include('template/bootstrap/dist/js/bootstrap.min.js')}}
    <!-- Menu Plugin JavaScript -->
    {{javascript_include('template/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js')}}
    <!--slimscroll JavaScript -->
    {{javascript_include('template/js/jquery.slimscroll.js')}}
    <!--Wave Effects -->
    {{javascript_include('template/js/waves.js')}}
    <!-- Custom Theme JavaScript -->
    {{javascript_include('template/js/custom.min.js')}}
    <!--Style Switcher -->
    {{javascript_include('template/plugins/bower_components/styleswitcher/jQuery.style.switcher.js')}}
</body>"
